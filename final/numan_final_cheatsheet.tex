...
\AddToShipoutPicture*{%
\AtTextUpperLeft{%
\raisebox{6pt}{\makebox[\textwidth][r]{\normalfont\scriptsize\textcolor{black!60}{Updated: 26 Sep 2026 00:44}}}%
}%
}
\begin{center}
...
\wk{Step 1} — evaluate $f(x)=1/\ln x$ at each node:\\
$f_0=1/\ln2\approx1.44270$; $f_1=1/\ln2.25\approx1.23315$; $f_2=1/\ln2.5\approx1.09136$;\\
$f_3=1/\ln2.75\approx0.98853$; $f_4=1/\ln3\approx0.91024$; $f_5=1/\ln3.25\approx0.84842$;\\
$f_6=1/\ln3.5\approx0.79824$; $f_7=1/\ln3.75\approx0.75657$; $f_8=1/\ln4\approx0.72135$.
...
$h=0.2$, $f(x,y)=x-4y$. \ex{Euler:} $f_0=0-4(-0.75)=3$: $y_1=-0.75+0.2(3)=-0.15$;\\
$f_1=0.2-4(-0.15)=0.8$: $y_2=-0.15+0.2(0.8)=0.01$; $f_2=0.4-0.04=0.36$: $y_3=0.01+0.2(0.36)=0.082$.\\
\ex{Midpoint:} half-step $(0.1,-0.75+0.1(3))=(0.1,-0.45)$, $f=0.1+1.8=1.9$ $\to y_1=-0.75+0.2(1.9)=-0.37$;\\
half-step $(0.3,-0.37+0.1(1.68))=(0.3,-0.202)$, $f=0.3+0.808=1.108$ $\to y_2=-0.37+0.2(1.108)=-0.1484$.
...
Given $x:0.2,0.3,0.4$; $f:-0.3341,-0.1769,0.0138$ ($h=0.1$). Fwd: at $0.2$: $\tfrac{-0.1769+0.3341}{0.1}=1.572$; at $0.3$: $1.907$. Bwd = same shifted ($1.572$ at $0.3$, $1.907$ at $0.4$).\\
Central at $0.3$: $\tfrac{0.0138+0.3341}{0.2}=1.7395=\tfrac12(1.907+1.572)$. 2nd: $\tfrac{0.0138-2(-0.1769)-0.3341}{0.01}=3.35$.
...
Widths $h_i=x_i-x_{i-1}$: $0.78910,0.66718,0.57794,0.50977,0.45601$;\\
heights $f(x_i^*)$ ($f=x^3-1.25x^2$): $-0.22007,-0.09663,-0.27964,0.39934,2.40035$;\\
e.g. $R_1=0.78910\cdot(-0.22007)\approx-0.17366$, total $R=\sum h_if(x_i^*)\approx0.89843$.\\
\wk{How to draw (Pract.5):} (1) mark the $n{+}1$ nodes on the $x$-axis; (2) for each subinterval compute $x_i^*$ via the $\alpha$-formula (any $\alpha$); (3) go up to the curve at $f(x_i^*)$ — that height is the bar top; (4) draw the bar over $[x_{i-1},x_i]$ (works below the axis too: height negative $\Rightarrow$ signed area).
